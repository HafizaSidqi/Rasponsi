...
public class ReadController {
    ...
    public ReadController(ReadModel model, Read read) {
        this.model = model;
        this.read = read;
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            int kolom = read.tabel.getSelectedColumn();     //mengambil nama ang ada di kolom index
       ...
       read.tabel.addMouseListener(new MouseAdapter(){
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            kolom = read.tabel.getSelectedColumn();     //mengambil nama ang ada di kolom index
