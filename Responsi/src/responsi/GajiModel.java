...
public class GajiModel {
    ...
    static final String DB_URL = "jdbc:mysql://localhost/responsipbo";   //nama database
    ...
    public String[][] readGaji() {      //dua dimensi(baris-kolom)
        try{
            int jmldata = 0;            //menampung jml data sebanyak jml data yang ada, default nya 0
            String data[][] = new String[getBanyakData()][10];   //menampung array, barisnya isinya di getBanyakData, kolomnya itu atribut
